export const recipes: Recipe[] = [
  {
    ...
    preparation: `Olivenöl in einem Topf erhitzen und das Mett darin krümelig braten. Zwiebel-, 
  ...
  },
  {
    ...
    preparation: `Den Ofen auf 200 °C Ober-/Unterhitze vorheizen. Blumenkohlröschen und Süßkartoffel auf ein Backblech geben, 
  ...
  },
  {
    ...
    preparation: `Den Backofen auf 200 Grad (Heißluft) vorheizen. Flammkuchenteig in 12 x 12 cm große Kreise ausstechen. Die Muffin-Form mit dem Speiseöl 
        einstreichen und die Teigkreise in die Mulden drücken. Den TK-Spinat auftauen lassen, dann zusammen mit dem Quark, Eiern, geriebenem Knoblauch und den Gewürzen verrühren. 
  ...
  },
  {
    ...
    preparation: `Rosinen in lauwarmes Wasser legen, um sie weich zu machen. Getrocknete Tomaten klein schneiden.
